...
import { LojaProvider } from './context/LojaContext'; // NOVO CONTEXTO ADICIONADO AQUI
...
const Dashboard = () => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>Visão Geral</h1>
      <p>Bem-vindo ao painel, {keycloakData?.primeiroNome || 'Usuário'}!</p>
    </div>
  );
};
...
const DashboardRevendedora = () => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>Meu Resumo</h1>
      <p>Bem-vinda, {keycloakData?.primeiroNome || 'Revendedora'}! Aqui você acompanhará suas metas e lucros.</p>
    </div>
  );
};
      ...
      <AuthProvider>
        <Router>
          {/* 
            ...
            O LojaProvider fica em volta da MaletaProvider.
            Como eles estão dentro do Router, eles conseguem ler a URL.
          */}
          <LojaProvider>
            <MaletaProvider>
